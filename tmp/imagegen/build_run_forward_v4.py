...
SOURCE = Path("tmp/imagegen/run_forward_v4_alpha.png")
OUTPUT = Path("assets/sprites/characters/base/frames/front/run_v4")
FRAME_SIZE = 128
MAX_SPRITE_HEIGHT = 116
BOTTOM_Y = (121, 122, 120, 118, 121, 122, 120, 118)
...
def main() -> None:
    ...
    strip.save(OUTPUT / "run_forward_v4_strip_8x1.png", optimize=True)
    grid.save(OUTPUT / "run_forward_v4_grid_4x2.png", optimize=True)
    ...
    preview[0].save(
        OUTPUT / "run_forward_v4_preview.gif",
        save_all=True,
