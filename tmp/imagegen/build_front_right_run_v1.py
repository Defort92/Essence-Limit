...
SOURCE = Path("tmp/imagegen/front_right_run_v1_alpha.png")
PALETTE_SOURCE = Path("assets/sprites/characters/base/front-right.png")
OUTPUT_DIR = Path("assets/sprites/characters/base/frames/front-right/run_v1")
FRAME_SIZE = 128
...
def main() -> None:
    ...
    strip.save(OUTPUT_DIR / "front_right_run_v1_strip_8x1.png", optimize=True)
    grid.save(OUTPUT_DIR / "front_right_run_v1_grid_4x2.png", optimize=True)

    preview = [frame.resize((512, 512), Image.Resampling.NEAREST) for frame in frames]
    preview[0].save(
        OUTPUT_DIR / "front_right_run_v1_preview.gif",
        save_all=True,
